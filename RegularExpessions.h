...
#define A_STRING_LITERAL(string) string, 4,	\
	...
	FST::NODE(308, \
		...
		FST::RELATION('ÿ', 1), FST::RELATION('À', 1), FST::RELATION('Á', 1), FST::RELATION('Â', 1),\
		...
		FST::RELATION('Þ', 1), FST::RELATION('ß', 1), FST::RELATION('1', 1), FST::RELATION('2', 1),\
		...
		FST::RELATION('ó', 2), FST::RELATION('ô', 2), FST::RELATION('õ', 2), FST::RELATION('ö', 2),\
		FST::RELATION('÷', 2), FST::RELATION('ø', 2), FST::RELATION('ù', 2), FST::RELATION('ú', 2),\
		FST::RELATION('û', 2), FST::RELATION('ü', 2), FST::RELATION('ý', 2), FST::RELATION('þ', 2),\
		FST::RELATION('ÿ', 2), FST::RELATION('À', 2), FST::RELATION('Á', 2), FST::RELATION('Â', 2),\
		FST::RELATION('Ã', 2), FST::RELATION('Ä', 2), FST::RELATION('Å', 2), FST::RELATION('¨', 2),\
		FST::RELATION('Æ', 2), FST::RELATION('Ç', 2), FST::RELATION('È', 2), FST::RELATION('É', 2),\
		FST::RELATION('Ê', 2), FST::RELATION('Ë', 2), FST::RELATION('Ì', 2), FST::RELATION('Í', 2),\
		FST::RELATION('Î', 2), FST::RELATION('Ï', 2), FST::RELATION('Ð', 2), FST::RELATION('Ñ', 2),\
		FST::RELATION('Ò', 2), FST::RELATION('Ó', 2), FST::RELATION('Ô', 2), FST::RELATION('Õ', 2),\
		FST::RELATION('Ö', 2), FST::RELATION('×', 2), FST::RELATION('Ø', 2), FST::RELATION('Ù', 2),\
		FST::RELATION('Ú', 2), FST::RELATION('Û', 2), FST::RELATION('Ü', 2), FST::RELATION('Ý', 2),\
		FST::RELATION('Þ', 2), FST::RELATION('ß', 2), FST::RELATION('1', 2), FST::RELATION('2', 2),\
