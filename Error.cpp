...
namespace Error 
{
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(113, "Превашен маскимальный размер таблицы лексем."),
		ERROR_ENTRY(114, "Превашен маскимальный размер таблицы идентификаторов."),
		...
		ERROR_ENTRY(161, "Некорректное выражение."),
